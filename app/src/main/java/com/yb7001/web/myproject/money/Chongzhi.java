            ...
            if (getArguments().getInt(ARG_SECTION_NUMBER) == 1) {
                ...
                new Thread() {
                    public void run() {
                        ...
                        Gson gson = new Gson();
                        if (!gonghang.trim().equals("请求数据失败！")) {
                ...
                Button btnRecharge = (Button) rootView.findViewById(R.id.btn_recharge);
                btnRecharge.setOnClickListener((View v) -> {
                    String requestUrl = MainGlobalData.SYS_DEPOSITE_URL + "?token=" + MainGlobalData.TOKEN;
